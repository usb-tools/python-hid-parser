...
class KeyboardKeypad(_Data):
    NO_EVENT = 0x00, 'No event indicated'
    KEYBOARD_ERROR_ROLL_OVER = 0x01, 'Keyboard ErrorRollOver'
    KEYBOARD_POST = 0x02, 'Keyboard POSTFail'
    KEYBOARD_ERROR_UNDEFINED = 0x03, 'Keyboard ErrorUndefined'
    ...
    KEYBOARD_ESCAPE = 0x29, 'Keyboard ESCAPE'
    KEYBOARD_DELETE = 0x2A, 'Keyboard DELETE (Backspace)'
    KEYBOARD_TAB = 0x2B, 'Keyboard Tab'
    KEYBOARD_SPACEBAR = 0x2C, 'Keyboard Spacebar'
    KEYBOARD_MINUS = 0x2D, 'Keyboard - and (underscore)'
    KEYBOARD_PLUS = 0x2E, 'Keyboard = and +'
    KEYBOARD_LEFT_BRACKET = 0x2F, 'Keyboard [ and {'
    KEYBOARD_RIGHT_BRACKET = 0x30, 'Keyboard ] and }'
    KEYBOARD_BACKSLASH = 0x31, 'Keyboard \\ and |'
    KEYBOARD_CARDINAL = 0x32, 'Keyboard Non-US # and ~'
    KEYBOARD_SEMICOLON = 0x33, 'Keyboard ; and :'
    KEYBOARD_QUOTE = 0x34, 'Keyboard \' and "'
    KEYBOARD_GRAVE = 0x35, 'Keyboard Grave Accent and Tilde'
    KEYBOARD_COMMA = 0x36, 'Keyboard , and <'
    KEYBOARD_DOT = 0x37, 'Keyboard . and >'
    KEYBOARD_SLASH = 0x38, 'Keyboard / and ?'
    KEYBOARD_CAPS_LOCK = 0x39, 'Keyboard Caps Lock'
    ...
    KEYBOARD_SCROLL_LOCK = 0x47, 'Keyboard Scroll Lock'
    KEYBOARD_PAUSE = 0x48, 'Keyboard Pause'
    KEYBOARD_INSERT = 0x49, 'Keyboard Insert'
    KEYBOARD_HOME = 0x4A, 'Keyboard Home'
    KEYBOARD_PAGE_UP = 0x4B, 'Keyboard PageUp'
    KEYBOARD_DELETE_FORWARD = 0x4C, 'Keyboard Delete Forward'
    KEYBOARD_END = 0x4D, 'Keyboard End'
    KEYBOARD_PAGE_DOWN = 0x4E, 'Keyboard PageDown'
    KEYBOARD_RIGHT_ARROW = 0x4F, 'Keyboard RightArrow'
    KEYBOARD_LEFT_ARROW = 0x50, 'Keyboard LeftArrow'
    KEYBOARD_UP_ARROW = 0x51, 'Keyboard DownArrow'
    KEYBOARD_DOWN_ARROW = 0x52, 'Keyboard UpArrow'
    KEYBOARD_NUM_LOCK = 0x53, 'Keypad Num Lock and Clear'
    ...
    KEYPAD_BACKSLASH = 0x64, 'Keyboard Non-US \\ and |'
    KEYPAD_APPLICATION = 0x65, 'Keyboard Application'
    KEYPAD_POWER = 0x66, 'Keyboard Power'
    KEYPAD_EQUALS = 0x67, 'Keypad ='
    ...
    KEYBOARD_EXECUTE = 0x74, 'Keyboard Execute'
    KEYBOARD_HELP = 0x75, 'Keyboard Help'
    KEYBOARD_MENU = 0x76, 'Keyboard Menu'
    KEYBOARD_SELECT = 0x77, 'Keyboard Select'
    ...
    KEYBOARD_VOLUME_UP = 0x80, 'Keyboard Volume Up'
    KEYBOARD_VOLUME_DOWN = 0x81, 'Keyboard Volume Down'
    KEYBOARD_LOCKING_CAPS_LOCK = 0x82, 'Keyboard Locking Caps Lock'
    KEYBOARD_LOCKING_NUM_LOCK = 0x83, 'Keyboard Locking Num Lock'
    KEYBOARD_LOCKING_SCROLL_LOCK = 0x84, 'Keyboard Locking Scroll Lock'
    KEYPAD_COMMA = 0x85, 'Keypad Comma'
    KEYPAD_EQUALS = 0x86, 'Keypad Equal Sign'
    KEYBOARD_INTERNATIONAL1 = 0x87, 'Keyboard International1'
    KEYBOARD_INTERNATIONAL2 = 0x88, 'Keyboard International2'
    KEYBOARD_INTERNATIONAL3 = 0x89, 'Keyboard International3'
    KEYBOARD_INTERNATIONAL4 = 0x8A, 'Keyboard International4'
    KEYBOARD_INTERNATIONAL5 = 0x8B, 'Keyboard International5'
    KEYBOARD_INTERNATIONAL6 = 0x8C, 'Keyboard International6'
    KEYBOARD_INTERNATIONAL7 = 0x8D, 'Keyboard International7'
    KEYBOARD_INTERNATIONAL8 = 0x8E, 'Keyboard International8'
    KEYBOARD_INTERNATIONAL9 = 0x8F, 'Keyboard International9'
    KEYBOARD_LANG1 = 0x90, 'Keyboard LANG1'
    KEYBOARD_LANG2 = 0x91, 'Keyboard LANG2'
    KEYBOARD_LANG3 = 0x92, 'Keyboard LANG3'
    KEYBOARD_LANG4 = 0x93, 'Keyboard LANG4'
    KEYBOARD_LANG5 = 0x94, 'Keyboard LANG5'
    ...
    KEYBOARD_ALTERNATE_ERASE = 0x99, 'Keyboard Alternate Erase'
    ...
    KEYBOARD_SEPARATOE = 0x9F, 'Keyboard Separator'
    ...
    KEYBOARD_EXSELL = 0xA4, 'Keyboard ExSel'
    KEYPAD_ZERO_ZERO = 0xB0, 'Keypad 00'
    KEYPAD_ZERO_ZERO_ZERO = 0xB1, 'Keypad 000'
    THOUSANDS_SEPARATOR = 0xB2, 'Thousands Separator'
    DECIMAL_SEPARATOR = 0xB3, 'Decimal Separator'
    CURRENCY_UNIT = 0xB4, 'Currency Unit'
    CURRENCY_SUBUNIT = 0xB5, 'Currency Sub-unit'
    KEYPAD_LEFT_PARENTHESIS = 0xB6, 'Keypad ('
    KEYPAD_RIGHT_PARENTHESIS = 0xB7, 'Keypad )'
    KEYPAD_LEFT_CURLY_BRACKET = 0xB8, 'Keypad {'
    KEYPAD_RIGHT_CURLY_BRACKET = 0xB9, 'Keypad }'
    ...
    KEYPAD_XOR = 0xC2, 'Keypad XOR'
    KEYPAD_AND = 0xC3, 'Keypad ^'
    KEYPAD_PERCENTAGE = 0xC4, 'Keypad %'
    KEYPAD_LESS_THAN = 0xC5, 'Keypad <'
    KEYPAD_MORE_THAN = 0xC6, 'Keypad >'
    KEYPAD_AMPERSAND = 0xC7, 'Keypad &'
    KEYPAD_2_AMPERSAND = 0xC8, 'Keypad &&'
    KEYPAD_VERTICAL_BAR = 0xC9, 'Keypad |'
    KEYPAD_2_VERTICAL_BAR = 0xCA, 'Keypad ||'
    KEYPAD_COLON = 0xCB, 'Keypad :'
    KEYPAD_CARDINAL = 0xCC, 'Keypad #'
    KEYPAD_SPACE = 0xCD, 'Keypad Space'
    KEYPAD_AT = 0xCE, 'Keypad @'
    KEYPAD_EXCLAMATION = 0xCF, 'Keypad !'
    KEYPAD_MEMORY_STORE = 0xD0, 'Keypad Memory Store'
    KEYPAD_MEMORY_RECALL = 0xD1, 'Keypad Memory Recall'
    KEYPAD_MEMORY_CLEAR = 0xD2, 'Keypad Memory Clear'
    KEYPAD_MEMORY_ADD = 0xD3, 'Keypad Memory Add'
    KEYPAD_MEMORY_SUBTRACT = 0xD4, 'Keypad Memory Subtract'
    KEYPAD_MEMORY_MULTIPLY = 0xD5, 'Keypad Memory Multiply'
    KEYPAD_MEMORY_DIVIDE = 0xD6, 'Keypad Memory Divide'
    KEYPAD_PLUS_MINUS = 0xD7, 'Keypad +/-'
    KEYPAD_CLEAR = 0xD8, 'Keypad Clear'
    KEYPAD_CLEAR_ENTRY = 0xD9, 'Keypad Clear Entry'
    KEYPAD_BINARY = 0xDA, 'Keypad Binary'
    KEYPAD_OCTAL = 0xDB, 'Keypad Octal'
    KEYPAD_DECIMAL = 0xDC, 'Keypad Decimal'
    KEYPAD_HEXADECIMAL = 0xDD, 'Keypad Hexadecimal'
    KEYBOARD_LEFT_CONTROL = 0xE0, 'Keyboard LeftControl'
    KEYBOARD_LEFT_SHIFT = 0xE1, 'Keyboard LeftShift'
    KEYBOARD_LEFT_ALT = 0xE2, 'Keyboard LeftAlt'
    KEYBOARD_LEFT_GUI = 0xE3, 'Keyboard Left GUI'
    KEYBOARD_RIGHT_CONTROL = 0xE4, 'Keyboard RightControl'
    KEYBOARD_RIGHT_SHIFT = 0xE5, 'Keyboard RightShift'
    KEYBOARD_RIGHT_ALT = 0xE6, 'Keyboard RightAlt'
    KEYBOARD_RIGHT_GUI = 0xE7, 'Keyboard Right GUI'
